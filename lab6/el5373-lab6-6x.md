...
Now, we will see how to terminal a TCP connection. Either host can terminate their side of the connection by sending a FIN. 
...
**Lab report**: When a server receives a SYN over a TCP connection, it sends a SYN ACK in response. When is the SYN ACK sent?

**Lab report**: When a host receives a data segment over a TCP connection, it sends an ACK. When is this ACK sent?
