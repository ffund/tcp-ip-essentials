...
**Note**: Students have reported problems using Microsoft Edge for this exercise - some Edge browser versions don't signal keepalive support in the HTTP header. I recommend using a Chrome, Firefox, or Safari browser instead.
