...
**Note**: this experiment assumes that you have set up a client node with Internet access via a NAT gateway, as described in the previous sections! If your client node does not have Internet access, you will need to set that up before you attempt the NTP experiments.
