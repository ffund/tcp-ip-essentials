...
```
sudo tcpdump -i eth1 -w $(hostname -s)-ftp-large.pcap
```
...
```
sudo tcpdump -i eth1 -w $(hostname -s)-tftp-large.pcap
```
...
```
sudo tcpdump -i eth1 -w $(hostname -s)-tftp-large-blocksize.pcap
```
...
```
sudo tcpdump -i eth1 -w $(hostname -s)-tftp-small.pcap
```
...
```
sudo tcpdump -i eth1 -w $(hostname -s)-ftp-small.pcap
```
...
```
sudo tcpdump -i eth1 -w $(hostname -s)-ftp-small-passive.pcap
```
